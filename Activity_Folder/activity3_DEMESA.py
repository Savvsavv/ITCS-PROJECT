...
print("\n\t\t")
print("\t\t\t Hi, my name is " + fullname + " and I'm " , age , " years old, " + gender + ". My birthday is on " + birthDate + ". I was born in " + birthPlace + ". I am a " + citizenship + ". " + civil_stat + " with a height of " ,(height) , " meters and a weight of " , (weight) ," kilograms. I am a " + religion + " and I live in " + address + " with a zipcode of " + zipcode + ". My number is " ,number , " and as for my email it is " + email + ". I am enrolled and currently studying at " + school + " and a BSIT student")